...
title: "BrainKey"
date: 2020-05-01
tags: ["brain-keyboard", "brain control interface", "signal processing", ""]
author: ["Chirag Bellara"]
description: "This book discusses Portugese irregular verbs in great details."
summary: "A Brain-Interfaced Keyboard using a NeuroSky Mindwave Mobile 2 EEG device that allows users with severe disabilities to communicate through eye blinks, type, erase, speak text, and raise alarms."
cover:
  image: "project4.png"
  alt: "BrainKey"
  relative: true
editPost:
  URL: "https://github.com/ChiragBellara/Brain-Keyboard/blob/main/README.md'"
  Text: "Read More"
showToc: false
...
> Python, Electron.js, NumPy, Pandas, Scikit-learn, Matplotlib, Signal Processing
